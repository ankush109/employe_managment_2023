...
export const DepartmentPage = () => {
  ...
  const styles = {
    ...
    textAlign: "center",
    color: "#3498db",
    backgroundImage: "linear-gradient(45deg, #3498db, #e74c3c)",
    backgroundClip: "text",
  ...
  return (
    <>
      ...
      <div className="flex1">
        ...
        />
        <div className="flex2">
          <div style={styles}>Welcome to Emager</div>
          <span>The best employee management system </span>
        </div>
      </div>
